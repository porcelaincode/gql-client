    ...
    >
      <div className="flex flex-col items-center w-64 h-full overflow-hidden text-gray-700 bg-gray-100 rounded transform transition hidden md:block">
        ...
        <div className="w-full px-2">
          ...
          <div className="flex flex-col items-center w-full my-2 border-t border-gray-300">
            <button className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300">
              <svg
                className="w-6 h-6 stroke-current"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <button
          disabled={loading}
          className="fixed bottom-0 flex items-center justify-start pl-5 w-full h-16 mt-auto bg-gray-200 hover:bg-gray-300"
          onClick={() => logout()}
        >
          <svg
            className="w-6 h-6 stroke-current"
